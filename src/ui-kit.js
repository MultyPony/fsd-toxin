...
const maskedTextField = require('./common.blocks/masked-text-field/masked-text-field.js');
...
const extCheckList = require('./common.blocks/ext-checkbox-list/ext-checkbox-list.js');
